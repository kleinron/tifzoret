  ...
  return (
    <aside className="panel settings no-print" aria-label="הגדרות">
      ...
      <fieldset className="block">
        ...
        <p className="hint">
          מוסיף מילים ידידותיות לגיל ~10 מקובץ מילים מובנה במחשב, בלי רשת.
        </p>
        <label className="toggle">
          <input
            type="checkbox"
        ...
        <p className="hint">
          כשמופעל, מילים שמכילות אות סופית (ם, ן, ץ, ף, ך) לא ייכנסו לתפזורת,
          וגם האותיות הסופיות עצמן לא יופיעו בריבוע.
        </p>
      </fieldset>
