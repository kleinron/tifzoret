...
4. אפשרויות:
   - **מילוי אוטומטי** — ביצירת תפזורת משלים מילים ידידותיות לילדים מקובץ מובנה (`src/data/kidWords.ts`), בלי רשת. הפעלה או כיבוי של האפשרות יוצרים תפזורת מחדש.
...
4. Optional:
   - **Automatic fill** — when a puzzle is built, extra kid-friendly words from the bundled corpus (offline). Turning the option on or off rebuilds the puzzle.
