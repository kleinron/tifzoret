...
7. **הדפס** — ההגדרות מוסתרות, והדף מכיל את הריבוע ואת בנק המילים. סימוני פתרון לא מודפסים.
...
7. **Print** hides settings; print shows the grid and word bank on one A4 page, without solve highlights.
